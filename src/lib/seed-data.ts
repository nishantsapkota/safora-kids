    ...
    templates: [
      {
        ...
        objective:
          'Choose safe road crossing behaviour per Nepal Traffic Rules.',
        questions: [
          'In Nepal, vehicles drive on which side of the road?',
          'You want to cross a road in Kathmandu. What should you do first?',
          'When crossing at a zebra crossing, which direction do you look first in Nepal?'
        ],
        answer: 'Look to your right first (vehicles come from right in Nepal)',
        distractors: [
          'Look to the left first',
          'Cross without looking',
          'Cross between parked cars',
          'Cross while phone is in your hand'
        ],
        explanation:
          'In Nepal, we drive on the left side, so vehicles approach from your right. Always look right first when crossing.'
      },
      {
        subtopic: 'helmet_safety',
        concept: 'helmet_use_nepal',
        objective: 'Know Nepal Police helmet mandate for motorcycle safety.',
        questions: [
          'According to Nepal Traffic Police, what must motorcycle riders always wear?',
          'Your older brother rides a motorcycle. What safety gear is required by law in Nepal?',
          'Which action keeps motorcycle riders safe during accidents in Nepal?'
        ],
        answer:
          'A properly fitted helmet (mandatory under Nepal Motor Vehicles Act)',
        distractors: [
          'A cap or scarf',
          'Nothing special',
        ...
        explanation:
          'Nepal Police enforce helmet use for all motorcycle riders. A helmet protects your head and can save your life.'
      },
      {
        subtopic: 'bus_safety',
        concept: 'school_bus_safety_nepal',
        objective: 'Practise safe school bus entry and exit in Nepal.',
        questions: [
          'When getting on a school bus in Nepal, what should you do?',
          'The school bus is moving. Where is the safest place for children to sit?',
          'What should you NOT do when getting off a bus in Nepal?'
        ],
        answer:
          'Wait in line, sit in your seat, and hold the handrail when getting off',
        distractors: [
          'Push to enter first',
          'Stand near the driver',
          'Jump from the moving bus',
          'Run across the road immediately'
        ],
        explanation:
          'School buses in Nepal follow safety rules. Stay calm, hold the handrail, and listen to the conductor.'
      },
      {
        subtopic: 'traffic_lights',
        concept: 'traffic_signal_meaning',
        objective: 'Understand traffic light signals in Nepal.',
        questions: [
          'What does a red traffic light mean for pedestrians at a crossing in Nepal?',
          'The traffic light turns green. What should you do before crossing?',
          'Which colour traffic light means you can cross safely?'
        ],
        answer: 'Look both ways, then cross carefully when the light is green',
        distractors: [
          'Cross immediately without looking',
          'Run across any time',
          'Ignore the signals',
          'Cross during red light'
        ],
        explanation:
          'Red means stop. Green means go, but always look both ways before crossing a street in Nepal.'
      },
      {
        subtopic: 'walking_safely',
        concept: 'pedestrian_safety_nepal',
        objective: 'Choose safe walking habits on Nepal roads.',
        questions: [
          'When walking along a busy road in Nepal, which side should you walk on?',
          'What should you avoid while walking to school in Nepal?',
          'Which habit is safest when walking on a Kathmandu street?'
        ],
        answer:
          'Walk on the left facing traffic, stay alert, and avoid distractions',
        distractors: [
          'Walk in the middle of the road',
          'Use your phone while walking',
          'Wear headphones and ignore traffic',
          'Walk without looking'
        ],
        explanation:
          'Walk on the left side of the road facing traffic so you can see vehicles coming toward you.'
      }
    ]
  },
  {
    ...
    templates: [
      {
        ...
        distractors: [
          'Run down the stairs immediately',
          'Stand near a window',
          'Use the lift',
          'Push classmates outside'
        ],
        explanation:
          'Drop, cover, and hold on protects you from falling items until shaking stops.'
      },
      {
        subtopic: 'flood',
        ...
        distractors: [
          ...
          'Hide near a riverbank',
          'Touch electric poles in water'
        ],
        explanation:
          'Higher ground is safer because flood water can move quickly.'
      },
      {
        subtopic: 'landslide',
        ...
        distractors: [
          'Stand below the slope to watch',
          'Collect fallen stones',
          'Shelter under loose soil',
          'Walk across cracks alone'
        ],
        explanation:
          'Moving away from the slope reduces danger from falling rocks or soil.'
      },
      {
        subtopic: 'fire_drill',
      ...
      },
      {
        ...
        distractors: [
          'Only video games',
          'Heavy glass decorations',
          'Open food without a container',
          'Sharp tools for children'
        ],
        explanation:
          'Water, light, and first aid supplies help during an emergency.'
      }
    ]
  },
  {
    ...
    templates: [
      {
        ...
        distractors: [
          'Touch it quickly',
          'Pull it with wet hands',
          'Cover it with paper',
          'Ask a younger child to check'
        ],
        explanation:
          'Damaged wires can shock you, so an adult should handle them.'
      },
      {
        subtopic: 'kitchen',
        ...
        distractors: [
          'Grab the pan handle',
          'Play beside the stove',
          'Touch steam to test it',
      ...
      },
      {
        ...
        distractors: [
          ...
          'Point it at a friend',
          'Hide it in your pocket',
          'Use it as a toy'
        ],
        explanation:
          'Sharp tools can cut, so careful use and adult help are important.'
      },
      {
        subtopic: 'medicine',
        ...
        distractors: [
          ...
          'Guess the amount',
          'Take it because it looks nice'
        ],
        explanation:
          'Medicine can be harmful if it is the wrong type or amount.'
      },
      {
        ...
        distractors: [
          ...
          'Smell it closely',
          'Pour it into a cup',
          'Use it to wash hands'
        ],
        explanation:
          'Cleaning liquids can hurt skin, eyes, or stomach, so adults should handle them.'
      }
    ]
  },
  {
    ...
    templates: [
      {
        ...
        explanation:
          'Cleaning a small cut and telling an adult helps prevent infection.'
      },
      {
        subtopic: 'burn',
      ...
      },
      {
        ...
        distractors: [
          ...
          'Put the head far backward',
          'Run around',
          'Blow the nose hard again and again'
        ],
      ...
      },
      {
        ...
        distractors: [
          'Keep it secret',
          'Move the person roughly',
          'Laugh and walk away',
          'Try every treatment you know'
        ],
        explanation:
          'A trusted adult or emergency helper can give the right support.'
      },
      {
        ...
        distractors: [
          'Use a dusty rag',
          'Use a leaf from the ground',
          'Leave dirt inside',
          'Use a shared dirty towel'
        ],
    ...
    templates: [
      {
        ...
        distractors: [
          'Wipe hands on clothes only',
          'Wash only once a week',
          'Use dirty water',
          'Skip soap after playing outside'
        ],
      ...
      },
      {
        ...
        distractors: [
          'Drink from puddles',
          'Drink water with dirt in it',
          'Share an unwashed cup',
          'Drink from an unknown stream'
        ],
      ...
      },
      {
        ...
        distractors: [
          'Eat food dropped on the ground',
          'Eat uncovered food with flies',
          'Share a dirty plate',
      ...
      },
      {
        ...
        distractors: [
          'Stay awake all night gaming',
          'Skip sleep before school',
          'Drink lots of soda at bedtime',
          'Sleep only in class'
        ],
    ...
    templates: [
      {
        ...
        distractors: [
          ...
          'Choose faster next time without reading',
          'Forget the topic',
          'Blame the question'
        ],
        explanation:
          'Reading feedback helps you learn why the safe answer is correct.'
      },
      {
        ...
        distractors: [
          ...
          'Stop learning that topic',
          'Click any answer quickly',
          'Ask the game to hide weak topics'
        ],
      ...
      },
      {
        ...
        distractors: [
          ...
          'Copy the first option every time',
          'Ignore the situation'
        ],
        explanation:
          'Scenario questions test how you use safety ideas in real life.'
      },
      {
        ...
        distractors: [
          'It is only random',
          'It means the first answer did not count',
          'It is punishment',
          'It removes your progress'
        ],
        explanation:
          'Spaced review checks real understanding, not just quick guessing.'
      }
    ]
  }
];
...
export function buildQuestionBank() {
  return moduleConfig.flatMap(module =>
    Array.from({ length: module.count }, (_, index) => {
      ...
      const difficulty =
        depth <= 1 ? 'easy' : depth === 2 || depth === 3 ? 'medium' : 'hard';
      const ageGroup =
        index % 3 === 0 ? '6-8' : index % 3 === 1 ? '9-11' : '12-14';
      const template = module.templates[index % module.templates.length];
      const questionText =
        template.questions[
          Math.floor(index / module.templates.length) %
